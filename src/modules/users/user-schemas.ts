...
const register = z.object({
    ...
    role: z.string({ invalid_type_error: "role must be string", required_error: "role is required", }),
...
const refreshToken = z.object({
    refreshToken: z.string({ required_error: "refresh_token is required", invalid_type_error: "refresh_token must be string" }).min(1)
}).strict()
