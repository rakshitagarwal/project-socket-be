export const codes: { [key: string]: string } = {
  ...
  P2006: 'The provided value for model field is not valid',
  ...
  P2017: 'The records for relation  between the parent name and  child name models are not connected',
  ...
  P3019: 'The data source provider specified in your schema does not match the one specified in the migration_lock.toml, ',
